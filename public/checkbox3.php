...
<form action="send_email.php" method="POST">
        What services will you select ?:
        <br>
        <label for="windows">Windows</label>
        <input type="checkbox" name="options[]" id="windows" value="windows"><br>

        <label for="office">Office</label>
        <input type="checkbox" name="options[]" id="office" value="office"><br>

        <label for="thermal">Thermal change</label>
        <input type="checkbox" name="options[]" id="thermal" value="thermal"><br><br>
