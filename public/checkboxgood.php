...
<!--- email tutorial https://www.kirupa.com/web/php_contact_form3.htm--->
<body>
...
<input type="text" name="email" size="19"><br>
    ...
    <input type="checkbox" name="check[]" value="windows_with_license"> Windows with license<br>
    <input type="checkbox" name="check[]" value="office_with_license"> Office with license<br>
    <input type="checkbox" name="check[]" value="hardware_defect"> Hardware defect<br> 
    <br>
